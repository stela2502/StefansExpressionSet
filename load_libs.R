...
## libpath <- '/home/slang/git_Projects/StefansExpressionSet/R/'
...
library(scales)
library(boot)
source(paste(libpath,'StefansExpressionSet_Cluster.R', sep=''))
source(paste(libpath,'StefansExpressionSet.R', sep=''))
